...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference("Produto.count") do
      post produtos_url, params: { produto: { desc: @produto.desc, nome: @produto.nome, quantidade: @produto.quantidade, string: @produto.string } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { desc: @produto.desc, nome: @produto.nome, quantidade: @produto.quantidade, string: @produto.string } }
